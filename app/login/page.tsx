      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-teal p-12 lg:flex">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-4">
            {[
              { icon: VoiceIcon, text: "Voice Profile grows from real approved posts" },
              { icon: ArchiveIcon, text: "Archive continuity stays attached to the account" },
              { icon: CheckIcon, text: "Built for serious LinkedIn publishing, not generic chat output" },
            ].map((item) => {
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                ...
                <Link href="/contact" className="text-xs text-teal hover:underline">Need help?</Link>
              </div>
